...
async def main():
    ...
    download_directory = "./data/precipitation/raw_harmonie"
    ...
    filenames = [file for file in filenames if any(date in file for date in missing)]
